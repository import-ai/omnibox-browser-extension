...
import { FeedbackContainer } from '@src/widgets/notification';
...
export default function Page() {
  ...
  const { isVisible: isFeedbackVisible, feedbackData } = useFeedbackVisibility();
  ...
  return (
    <>
      ...
      <FeedbackContainer isVisible={isFeedbackVisible} data={feedbackData} />
    </>
  );
}
